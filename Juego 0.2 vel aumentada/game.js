...
class playGame extends Phaser.Scene {
    ...
    create() {
        ...
        scoreText = this.add.text(80, 100, "Score: 0", { fontSize: '32px', fill: '#fff' });
        vidasText = this.add.text(300, 100, 'Vidas: 3', { fontSize: '32px', fill: '#fff' });
    ...
    addPlatform(platformWidth, posX) {
        ...
        if (this.dying) {
            ...
            if (this.platformPool.getLength()) {
                ...
                if (score > 15){
                    platform.setVelocityX(gameOptions.platformStartSpeed * -2);
                }
                if (score > 30){
                    platform.setVelocityX(gameOptions.platformStartSpeed * -2);
                }
